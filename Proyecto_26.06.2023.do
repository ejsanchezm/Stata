...
decode Escolari, gen(Escolari1)
encode Escolari1, gen(Esc)
...
* No borrar: estas son notas de Eduardo Sánchez
* label define zonlabel 0"urbana" 1"rural"
* encode ZONA1, gen(zon) label(zonlabel)
